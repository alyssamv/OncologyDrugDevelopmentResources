...
This file gives the user a way of getting cleaned information about a publication. This is superior
to simply downlaoding the CSV file from PubMed directly, because it gives parsed results. This
leaves very little left to the researcher, and can leave more time to extract important information from the text itself (such as methods, etc). If you find this useful and share, please credit me!
